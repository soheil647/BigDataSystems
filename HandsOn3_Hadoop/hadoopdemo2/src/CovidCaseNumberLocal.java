...
public class CovidCaseNumberLocal extends Configured implements Tool { 

	public int run(String[] args) throws Exception  {

		if(args.length !=2) {

			System.err.println("Usage:  CovidCaseNumberLocal <input path> <outputpath>");
		...
		Job job = new Job();
		job.setJobName("Covid Case Counter");
	...
	public static void main(String[] args) throws Exception {
		...
		CovidCaseNumberLocal driver = new CovidCaseNumberLocal();
